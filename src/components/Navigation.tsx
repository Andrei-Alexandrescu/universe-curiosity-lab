...
const Navigation = () => {
  ...
  const navItems = [
    { path: '/', label: 'Acasă', icon: Rocket },
    { path: '/planete-galaxii', label: 'Planete și Galaxii', icon: Globe },
    { path: '/test', label: 'Test interactiv', icon: Brain },
    { path: '/fapte-interesante', label: 'Știați că...?', icon: Lightbulb },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2">
            <div className="text-2xl animate-rotate-slow">🌌</div>
